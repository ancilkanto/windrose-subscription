...
<div class="arabic-section">
    <div class="arabic-content">
        <p><?php printf(wp_kses_post(__(' فشل دفع طلب اشتراكك (الرقم  :%d).  ', 'windros-subscription')), $subscription->id); ?></p>
        <p><?php esc_html_e('يرجى تسجيل الدخول إلى حسابك لتحديث وسيلة الدفع.  '); ?></p>
    </div>
...
<div class="english-section">
    ...
    <div class="english-content">
        ...
        <p><?php esc_html_e('Please login to your account to update your payment method.', 'windros-subscription'); ?></p>
    </div>
