...
/**
 * Windrose Subscription Admin Cancelled Email (Plain Text)
 *
...
<?php printf( __( 'A subscription (ID: %d) has been cancelled.', 'windros-subscription' ), $subscription->id ); ?>
...
<?php printf( __( 'Cancellation Date: %s', 'windros-subscription' ), date('Y-m-d H:i:s', strtotime($subscription->updated_at)) ); ?>
