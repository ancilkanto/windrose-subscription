...
<p><?php printf( __( 'A new subscription (ID: %d) has been <strong>activated</strong>.', 'windros-subscription' ), $subscription->id ); ?></p>
...
<p><?php printf( __( 'Activation Date: %s', 'windros-subscription' ), date('Y-m-d H:i:s', strtotime($subscription->created_at)) ); ?></p>
