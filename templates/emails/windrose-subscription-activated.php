...
<div class="arabic-section">
    <div class="arabic-content">
        <p><?php printf(esc_html__('  مفعل الآن (الرقم  :%d) مرحبًا، اشتراكك   ', 'windros-subscription'), $subscription->id); ?></p>
    </div>
    ...
    <div class="arabic-content">
        ...
        <p><?php esc_html_e('  تم تفعيل اشتراكك بنجاح! ستتلقى تحديثات منتظمة حول حالة طلبك.  ', 'windros-subscription'); ?></p>
        <p><?php esc_html_e('  شكرًا لاختيارك خدمة الاشتراك لدينا!   ', 'windros-subscription'); ?></p>
