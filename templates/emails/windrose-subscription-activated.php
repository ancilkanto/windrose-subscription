...
<div class="arabic-section">
    <div class="arabic-content">
        <p><?php printf(esc_html__('مرحباً، اشتراكك (الرقم: %d) نشط الآن.', 'windros-subscription'), $subscription->id); ?></p>
    </div>
    ...
    <div class="arabic-content">
        <p><?php esc_html_e('تم تفعيل اشتراكك بنجاح! ستتلقى تحديثات منتظمة حول حالة طلباتك.', 'windros-subscription'); ?></p>
        <p><?php esc_html_e('شكراً لك على اختيار خدمة الاشتراك لدينا!', 'windros-subscription'); ?></p>
    </div>
...
<div class="english-section">
    ...
    <div class="english-content">
        <p><?php printf(wp_kses_post(__('Hello, your subscription (ID: %d) is now <strong>active</strong>.', 'windros-subscription')), $subscription->id); ?></p>
    </div>
    ...
    <div class="english-content">
        <p><?php esc_html_e('Your subscription has been successfully activated! You will receive regular updates about your order status.', 'windros-subscription'); ?></p>
        <p><?php esc_html_e('Thank you for choosing our subscription service!', 'windros-subscription'); ?></p>
    </div>
