...
<p><?php printf( __( 'A subscription (ID: %d) has been <strong>paused</strong>.', 'windros-subscription' ), $subscription->id ); ?></p>
...
<p><?php printf( __( 'Pause Date: %s', 'windros-subscription' ), date('Y-m-d H:i:s', strtotime($subscription->updated_at)) ); ?></p>
