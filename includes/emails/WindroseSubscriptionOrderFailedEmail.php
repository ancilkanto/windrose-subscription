...
class WindroseSubscriptionOrderFailedEmail extends \WC_Email {
        ...
        public function trigger( $subscription_id, $reason = '' ) {
            error_log('Windrose Subscription: Order failed email trigger method called for subscription ID: ' . $subscription_id);
