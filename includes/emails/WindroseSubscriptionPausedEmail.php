...
class WindroseSubscriptionPausedEmail extends \WC_Email {
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'heading_arabic' => array(
                    ...
                    'placeholder'   => __( 'تم إيقاف اشتراكك مؤقتاً', 'windros-subscription' ),
                    'default'       => __( 'تم إيقاف اشتراكك مؤقتاً', 'windros-subscription' )
                ),
                'email_type' => array(
        ...
        public function get_default_subject() {
            return __( 'Your subscription has been paused', 'windros-subscription' );
        }
        ...
        public function get_heading_arabic() {
            return $this->get_option( 'heading_arabic', __( 'تم إيقاف اشتراكك مؤقتاً', 'windros-subscription' ) );
        }
